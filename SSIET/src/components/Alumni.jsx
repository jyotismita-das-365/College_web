    ...
    <div className="bg-gray-50 min-h-screen py-10 pt-24">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <p className="text-center text-gray-600 mb-10 max-w-2xl mx-auto">
          Meet some of our distinguished alumni who have made their mark in the
          industry across the globe. Their journeys inspire our current students
          to dream big and achieve more.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {alumniData.map((alumnus, idx) => (
            ...
            <div
              key={idx}
              className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center hover:shadow-xl transition-shadow duration-300"
            >
              {/* Alumni Image */}
              <img
                src={alumnus.image}
